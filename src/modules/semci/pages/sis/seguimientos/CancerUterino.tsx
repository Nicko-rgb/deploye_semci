...
const CancerUterino: React.FC = () => {
    ...
    const obtenerDatosGeneral = async () => {
        const response = await seguimientosService.getCancerUterinoGeneral(filtros.anio, filtros.mes !== '' ? Number(filtros.mes) : undefined, filtros.nombre_red);
    ...
    const obtenerDatosEstablecimientos = async (microred: string) => {
        const response = await seguimientosService.getCancerUterinoByMicrored(filtros.anio, filtros.nombre_red, microred);
    ...
    const exportarDatosNominales = async () => {
        try {
            ...
            await seguimientosService.exportarNominalCancerUterino(filtros.anio, filtros.mes, filtros.nombre_red, '', '');
    ...
    const exportarDatosNominalesMicrored = async (nom_microred: string) => {
        try {
            ...
            await seguimientosService.exportarNominalCancerUterino(filtros.anio, filtros.mes, filtros.nombre_red, nom_microred, '');
    ...
    const exportarDatosNominalesEstablecimiento = async (nom_microred: string, nom_establecimiento: string) => {
        try {
            ...
            await seguimientosService.exportarNominalCancerUterino(filtros.anio, filtros.mes, filtros.nombre_red, nom_microred, nom_establecimiento);
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold">
                                Seguimiento de Cáncer Uterino - SIS
                            </h1>
